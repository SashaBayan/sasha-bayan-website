...
export const epks: EPKs = {
  falling: createEPK({
    ...
    songHref: "https://on.soundcloud.com/9eAXv",
  }),
  lucid: createEPK({
    title: "lucid",
    ...
    songHref: "https://on.soundcloud.com/piwp4",
  }),
  wandering: createEPK({
    title: "wandering",
    ...
    songHref: "https://on.soundcloud.com/QexDA",
  }),
  montreux: createEPK({
    title: "montreux",
  ...
  geneva: createEPK({
    ...
    songHref: "https://on.soundcloud.com/P8dgK",
  }),
  memories: createEPK({
    title: "memories",
    ...
    songHref: "https://on.soundcloud.com/GsB6W",
  }),
  boundless: createEPK({
    title: "boundless",
    ...
    songHref: "https://on.soundcloud.com/3ayTB",
  }),
  maybe: createEPK({
    title: "maybe",
    ...
    songHref: "https://on.soundcloud.com/k2uW8",
  }),
  gone: createEPK({
    title: "gone",
    ...
    songHref: "https://on.soundcloud.com/8fW5j",
  }),
  tomorrow: createEPK({
    title: "tomorrow",
    ...
    songHref: "https://on.soundcloud.com/nE7ak",
  }),
  enough: createEPK({
    title: "enough",
    subheader:
    ...
    songHref: "https://on.soundcloud.com/LRtxJ",
  }),
};
