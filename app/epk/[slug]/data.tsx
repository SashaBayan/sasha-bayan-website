...
export const epks: EPKs = {
  falling: createEPK({
    ...
    songHref:
      "https://open.spotify.com/track/3FjsL7AWVENz8DNyfhy1bX?si=9697cddd75794cdf",
  }),
  lucid: createEPK({
    title: "lucid",
    ...
    songHref:
      "https://open.spotify.com/track/5cDxDU9hcm69DXQi6lbreG?si=7b915bd5687c4194",
  }),
  wandering: createEPK({
    title: "wandering",
  ...
  geneva: createEPK({
    ...
    songHref:
      "https://open.spotify.com/track/3oHfPbPGSM9TaKT7AlY45b?si=7cb5ea0b353c4b08",
  }),
  memories: createEPK({
    title: "memories",
    ...
    songHref:
      "https://open.spotify.com/track/3V7d9KWmIDYhjXziyHiOk3?si=0ead0639f4e84c52",
  }),
  boundless: createEPK({
    title: "boundless",
    ...
    songHref:
      "https://open.spotify.com/track/1MsejyGbIZwH1VysdAhzHu?si=cdef0fecdef2418c",
  }),
  maybe: createEPK({
    title: "maybe",
    ...
    songHref: "https://open.spotify.com/album/4bOpltnhUFqq01Ojh2iQ33",
  }),
  gone: createEPK({
    title: "gone",
    ...
    songHref: "https://open.spotify.com/album/7Ft7040mzkbB5Q2OkZWioT",
  }),
  tomorrow: createEPK({
    title: "tomorrow",
    ...
    songHref:
      "https://open.spotify.com/track/4ItHwLmzlIyICDMPFJJ6HP?si=48109d5f61c94ad0",
  }),
  enough: createEPK({
    title: "enough",
    subheader:
    ...
    songHref:
      "https://open.spotify.com/album/70xurRaRvInn6h7KL07GcT?si=_Wem8YgjRx64OOTgHv8Trw",
  }),
};
